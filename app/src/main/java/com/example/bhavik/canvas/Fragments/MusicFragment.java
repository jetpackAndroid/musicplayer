...
public class MusicFragment extends Fragment implements SongAdapter.customButtonListener, MediaController.MediaPlayerControl {
    ...
    public void onAttach(Activity activity) {
        ...
        try{
        passSongList = (passSongList) activity;
        }
